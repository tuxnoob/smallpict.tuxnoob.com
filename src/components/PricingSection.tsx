                        ...
                        <div key={plan.id} className={`flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 ${plan.highlight ? 'ring-2 ring-blue-600 shadow-xl scale-105 z-10' : ''}`}>
                            <div>
                                <div className="flex items-center justify-between gap-x-4">
                                    <h3 className={`text-lg font-semibold leading-8 ${plan.highlight ? 'text-blue-600' : 'text-gray-900'}`}>{plan.title}</h3>
                                    {plan.highlight && (
                                        <span className="rounded-full bg-blue-50 px-2.5 py-1 text-xs font-semibold leading-5 text-blue-600">Most popular</span>
                                    )}
                                </div>
