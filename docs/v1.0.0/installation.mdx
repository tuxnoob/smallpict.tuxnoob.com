...
| **File Size Limit** | 2 MB per file | **Unlimited** | **Unlimited** |
| **Domain Limit** | Unlimited | 1 Domain | **Unlimited Domains** |
| **Animation Support** | ❌ Blocked | ✅ GIF, WebP, AVIF | ✅ GIF, WebP, AVIF |
| **Smart Scaling** | ❌ Fixed (512MB RAM) | ✅ Dynamic (up to 5GB RAM) | ✅ Dynamic (up to 5GB RAM) |
| **Support** | Community / Forum | Email Support | Developer Support |
| **Format Conversion** | Standard (WebP) | Advanced (AVIF/WebP) | Advanced (AVIF/WebP) |
...
2.  **NAT Gateway vs. NAT Instance (Cost Saving)**:
    ...
    *   👉 **Tutorial**: [How to Remove NAT Gateway & Change to NAT Instance](https://www.tuxnoob.com/posts/AWS-ECS-Cost-Optimization-Remove-NAT-Gateway-Change-To-NAT-Instance/)
